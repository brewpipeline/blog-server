...
impl Into<EAuthor> for Author {
    fn into(self) -> EAuthor {
        EAuthor {
            id: self.id,
            slug: self.base.slug,
            first_name: if self.base.blocked == 0 { self.base.first_name } else { None },
            last_name: if self.base.blocked == 0 { self.base.last_name } else { None },
            middle_name: if self.base.blocked == 0 { self.base.middle_name } else { None },
            mobile: if self.base.blocked == 0 { self.base.mobile } else { None },
            email: if self.base.blocked == 0 { self.base.email } else { None },
            registered_at: self.base.registered_at,
            status: if self.base.blocked == 0 { self.base.status } else { None },
            image_url: if self.base.blocked == 0 { self.base.image_url } else { None },
