...
mod webhook_new_post_published_service;
...
pub use webhook_new_post_published_service::{
    create_discord_new_post_published_service, create_telegram_new_post_published_service,
};
